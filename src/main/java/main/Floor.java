...
public class Floor {
    ...
    /**
     * Method for generating the mods for a floor.
     * @param floorModSeed the int to determine the mod
     */
    public void getFloorMods(int floorModSeed) {
        switch (floorModSeed) {
            case 1:
                System.out.println("You hear the echos of yyz around you, Neil Peart smiles upon"
                        + " you. +5 to attack power");
            ...
            case 2:
                System.out.println("The heat of this floor has warped your instrument. Your "
                        + "defenses are weakened! -3 to defense");
            ...
            case 3:
                System.out.println("You happen upon Dante who is having "
                        + "a nice visit in the underworld."
